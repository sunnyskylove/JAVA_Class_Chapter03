...
public class Application03 {
    public static void main(String[] args) {
        ...
        *  */
        ...
        /* 목차. 1. 전달인자로 값 전달 테스트 */
        app3.testMethod(222);
//        app3.testMethod("20");  // age의 숫자값넣어야해서 문자열은 안됨. 이 경우, 밑에 String으로 변경해야함

        /* 목차. 2. 변수에 저장한 값 전달 테스트 */
        /* 목차. 2-1. 변수에 저장된 값을 이용하여 값을 전달할 수 있다. */
        int age = 40;
        app3.testMethod(age);    //한번 더 같은 메소드 호출하는데 다른 값으로 요청


        /* 목차. 2-2. 자동형변환을 이용하여 값 전달을 할 수 있다. */
//        byte byteAge = 10;
//        app3.testMethod(byteAge);
//        //이상하다..오류난다. 10세입니다 나와야함..;;

//        /* 목차. 2-3. 강제형변환을 이용해서 값 전달을 할 수 있다. */
//        app3.testMethod((int)longAge);
        // 앞에 작은부피 int를 ()로 넣어서 명시해준다. 또 오류남..ㅠㅠ

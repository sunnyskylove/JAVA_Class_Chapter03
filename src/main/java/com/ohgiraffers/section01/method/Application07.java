...
//        app7.plusTwoNumbers(first,second);  // 출력해도 값은 안나옴, 아직 떠있는 상태
        ...
        System.out.println("두 수를 나눈 나머지 값: " + app7.remainderTwoNumber(first,second));
    ...
    public int remainderTwoNumber(int first1, int second1){

...
//       = java.util.Scanner sc = new java.util.Scanner(System.in); 이지만 좀 더 간단한 형태로..
        ...
        // 앞에 있는(java.util) 구문을 생략한것: 자동으로 import가 되는 것임. 안된다면 Alt+enter
        ...
        /* 필기. nextLong() : 입력 받은 값을 long 형으로 반환한다. (정수)*/
        System.out.print("금액을 입력해주세요 : ");
        long money = sc.nextLong();
        System.out.println(" 입력하신 금액은 : " + money + "입니다.");

        /* 필기. nextFloat() : 입력 받은 값을 float 형으로 반환한다 (실수)_하지만 잘 안쓴다.*/
        ...
        /* 목차. 2-5. 문자형 값 입력받기 */
        sc.nextLine();      // 나중에 다시 공부~~spring 에서 토큰으로 받음????
        System.out.print("아무 문자나 입력해주세요 : ");
        char ch = sc.nextLine().charAt(0);
        System.out.println("입력하신 문자는 " + ch + "입니다.");
        // 예) 조평훈 이름 적었을떄 풀네임 적으면 0번째인 "조" 로 나온다.
